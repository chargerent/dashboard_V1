    ...
    return (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[100] flex justify-center items-center p-4" role="presentation">
            <div role="dialog" aria-modal="true" aria-labelledby="inactivity-modal-title" className="bg-white p-8 rounded-lg shadow-xl text-center max-w-sm mx-auto">
                <h2 id="inactivity-modal-title" className="text-2xl font-bold mb-4">{t('session_timeout_title') || 'Are you still there?'}</h2>
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <button type="button" onClick={onStay} className="px-6 py-2 rounded-md bg-blue-500 text-white hover:bg-blue-600">{t('stay_logged_in') || 'Stay Logged In'}</button>
                </div>
            </div>
        </div>
        </ModalPortal>
