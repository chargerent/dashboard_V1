...
const HTTP_FUNCTION_NAME_MAP = {
  ...
  payouts_generateMonthlyReports: 'payouts_httpGenerateMonthlyReports',
  payouts_listReports: 'payouts_httpListReports',
  payouts_approveAndSend: 'payouts_httpApproveAndSend',
  payouts_markPaid: 'payouts_httpMarkPaid',
