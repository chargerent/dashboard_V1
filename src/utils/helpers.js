...
export const normalizeKioskData = (kiosks) => {
    ...
    return kiosks.map(kiosk => {
        ...
        return {
            ...
            terminalStateOccurredAt: kiosk.terminalStateOccurredAt || kiosk.terminalstateoccurredat || null,
            activity: kiosk.activity || null,
            lastUpdated,
            ...
            uiVersion: kiosk.ui?.version || kiosk.uiVersion || kiosk.uiversion,
